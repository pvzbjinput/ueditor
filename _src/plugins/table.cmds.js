...
(function() {
        ...
        execCommand: function(cmd, align) {
            ...
            if (selectedTds.length) {
                for (var i = 0, ci; ci = selectedTds[i++];) {
                    ...
                    domUtils.setStyle('text-align', align);
                }
            }
        }
    };
        ...
        execCommand: function(cmd, valign) {
            ...
            if (selectedTds.length) {
                for (var i = 0, ci; ci = selectedTds[i++];) {
                    ...
                    domUtils.setStyle('vertical-align', valign);
                }
            }
        }
    };
    ...
    //单元格样式
    function cellclass(cell, data) {
        domUtils.removeClasses(cell, "td-title td-control-title td-control");
        switch (data) {
            case "cancle":
                break;
            default:
    ...
    UE.commands['edittd'] = {
        ...
        execCommand: function(cmd, bkColor, width, height, border) {
            var me = this,
                ut = getUETableBySelected(me);
            ...
            if (!ut) {
                ...
                if (cell) {
                    ...
                    domUtils.removeClasses(cell, "td-noborder");
                    if (border) {
                        domUtils.addClass(cell, "td-noborder");
                    }
                }
            } else {
                utils.each(ut.selectedTds, function(cell) {
